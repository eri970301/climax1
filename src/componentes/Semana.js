    ...
    render() { 
        return ( 
            ...
            <div className="daily">
              ...
              <p>Min. temperature: {this.props.tempmind1}</p>
            </div>
            <div className="daily">
              <p>{this.props.dia2}</p>
              ...
              <p>Min. temperature: {this.props.tempmind2}</p>
            </div>
            <div className="daily">
              <p>{this.props.dia3}</p>
              ...
              <p>Min. temperature: {this.props.tempmind3}</p>
            </div>
            <div className="daily">
              <p>{this.props.dia4}</p>
              ...
              <p>Min. temperature: {this.props.tempmind4}</p>
            </div>
          </div>
         );
    }
